...
class TestEmailManager(unittest.TestCase):
    ...
    def test_sendEmail(self):
        eMailContent = EmailEntity('This is a test','keivoxlab@gmail.com','keivoxlab@gmail.com','This is the body',[],datetime.datetime.now())
    ...
    def test_sendEmailWithAttachmentsJPG(self):
        ...
        eMailContent = EmailEntity('This is a test','keivoxlab@gmail.com','keivoxlab@gmail.com','This is the body',attachments,datetime.datetime.now())
        self.assertTrue(EmailManager().sendEmail(eMailContent,SmtpSettings()))             
...
#         self.assertEqual(res_json['To'],"keivoxlab@gmail.com")
